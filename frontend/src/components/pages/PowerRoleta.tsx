    ...
    <div className="w-full text-stone-200 font-serif selection:bg-purple-900/30 pt-4">
      <div className="w-full mx-auto space-y-10 animate-in fade-in duration-700">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-stone-950 border border-white/5 rounded-lg p-5 text-center shadow-2xl relative overflow-hidden group hover:border-purple-500/30 transition-colors">
        ...
        <div className="flex flex-col items-center gap-10 py-20 bg-gradient-to-b from-stone-950 to-black rounded-xl border border-white/5 relative overflow-hidden shadow-2xl">
            ...
            {/* Spin Control Button */}
             ...
             {result && !spinning && (
                <div className="z-20 animate-in fade-in zoom-in duration-500 mt-8 text-center bg-stone-950/80 px-12 py-8 rounded-3xl border border-purple-500/40 backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.8)] min-w-[300px]">
