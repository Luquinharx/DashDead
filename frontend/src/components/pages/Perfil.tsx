      ...
      <div className="max-w-4xl mx-auto p-6 space-y-8 animate-in fade-in duration-700">
        ...
        <div className="bg-stone-950/50 border border-white/10 rounded-sm p-6 backdrop-blur-sm relative overflow-hidden group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
            ...
            <div className="space-y-2">
              <label className="text-xs text-stone-600 uppercase tracking-widest font-bold">Rank</label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 pt-6 border-t border-white/5 relative z-10">
            ...
            <div className="text-center p-4 bg-black/40 border border-white/5 rounded-sm">
              ...
              <p className="text-2xl font-bold text-white font-mono">
                {(stats?.currentAll || 0).toLocaleString('pt-BR')}
              </p>
            </div>
            <div className="text-center p-4 bg-black/40 border border-white/5 rounded-sm">
                    ...
                    <td className="px-6 py-3 text-center">
                      {!r.entregue && (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 text-[10px] uppercase tracking-widest text-emerald-500 hover:text-emerald-400 transition-colors border border-emerald-900/30 px-2 py-1 rounded-sm hover:bg-emerald-950/20"
                        >
